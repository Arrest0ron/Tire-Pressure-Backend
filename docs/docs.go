...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/api/tire-pressure-entries/add/{tire_id}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/tire-pressure-entries/{tire_id}/{tire_pressure_id}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/serializer.TirePressureEntryUpdateJSON"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/serializer.TirePressureListJSON"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/serializer.TirePressureDetailJSON"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/serializer.TirePressureUpdateJSON"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/serializer.TireJSON"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "name": "tire_material_coefficient",
                        "in": "formData"
                    },
                    {
                        "type": "number",
                        "description": "Коэффициент толщины",
                        "name": "tire_thickness_coefficient",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                    ...
                    {
                        "type": "file",
                        "description": "Фото шины",
                        "name": "photo",
                        "in": "formData"
                    },
                    {
                        "type": "file",
                        "description": "Видео шины",
                        "name": "video",
                        "in": "formData"
                    }
                ],
    ...
    "definitions": {
        ...
        "serializer.TireJSON": {
            ...
            "properties": {
                ...
                "tire_material_coefficient": {
                    "type": "number"
                },
                "tire_thickness_coefficient": {
                    "type": "number"
                },
                "tire_title": {
                    "type": "string"
        ...
        "serializer.TirePressureDetailJSON": {
            "type": "object",
            "properties": {
                "air_temperature": {
                    "type": "number"
                ...
                "entries": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/serializer.TirePressureEntryViewJSON"
                    }
                },
                "moderator_login": {
                    "type": "string"
        ...
        "serializer.TirePressureEntryUpdateJSON": {
            "type": "object",
            "properties": {
                "coating_coefficient": {
                    "type": "number"
        ...
        "serializer.TirePressureEntryViewJSON": {
            "type": "object",
            "properties": {
                "coating_coefficient": {
                    "type": "number"
        ...
        "serializer.TirePressureListJSON": {
            "type": "object",
            "properties": {
                "air_temperature": {
                    "type": "number"
        ...
        "serializer.TirePressureUpdateJSON": {
            "type": "object",
            "properties": {
                "air_temperature": {
                    "type": "number"
